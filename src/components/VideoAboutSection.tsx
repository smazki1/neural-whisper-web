...
import aviPortraitAsset from '@/assets/avi-fried-speaking.jpg.asset.json';
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              ...
              <p>
                כאן זה בית ליוצרים, יזמים ואנשי מקצוע שלא מוכנים להישאר מאחור במהפכת ה-AI.
              </p>
              
              <p>
                תמצאו כאן שיטות עבודה, כלים ומיומנויות שיהפכו את ה-AI לכוח שלכם - ויתנו לכם את הבטחון והכישורים להישאר רלוונטים בעידן הדיגיטלי.
              </p>
