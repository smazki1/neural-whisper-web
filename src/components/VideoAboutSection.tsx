        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              ...
              <p>
                שמי אבי פריד ותודה שבאתם.
              </p>
              
              <p>
                כאן זה בית ליוצרים, יזמים ואנשי מקצוע שלא מוכנים להישאר מאחור, ומבינים שהמיומנות הקריטית ביותר היום היא לדעת איך לעבוד נכון עם AI, ולהפוך אותו לחלק מהעבודה שלכם.
              </p>
              ...
              <p>
                מה אם הפתרון הוא לא לעבוד קשה יותר, אלא לשנות את הדרך שבה מתייחסים לשינוי? זו לא מהפכה טכנולוגית, זו מהפכה תפיסתית. הכלים החדשים זמינים לכולם, אבל היכולת להפיק מהם תוצאות יוצאות דופן היא מיומנות נרכשת.
              </p>
              
              <p>
                המטרה שלי היא להעניק לכם שיטות עבודה מוכחות שלא רק יהפכו את ה-AI לעוזר אישי חכם שלכם - אלה אתן לכם את הבטחון והכישורים שיעזרו לכם להשאר רלוונטים בתחומכם.
              </p>
            </motion.div>
          </motion.div>
        </div>
