        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              ...
              <p>
                כאן זה בית ליוצרים, יזמים ואנשי מקצוע שלא מוכנים להישאר מאחור, ולהיות על זה במהפכת ai
              </p>
              
              <p>
                תוכלו למצוא כאן שיטות עבודה, כלים ומיומנויות שלא רק יהפכו את ה-AI לעוזר אישי חכם שלכם - אלה אתן לכם את הבטחון והכישורים שיעזרו לכם להשאר רלוונטים בעידן הדגיטלי.
              </p>
              
              <p>
                המשימה שלי פשוטה: להפוך את הטכנולוגיה לנגישה ומעשית עבור כל מי שרוצה להשתמש בכוח של הבינה המלאכותית כדי להשיג יותר בפחות זמן.
              </p>
            </motion.div>
          </motion.div>
        </div>
