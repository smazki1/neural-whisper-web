        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-brand-text/80">
              <li>
                <a href="#workshops" className="hover:text-brand-accent transition-colors duration-200">
                  סדנאות יצירה ופיתוח
                </a>
              </li>
              <li>
                <a href="#consulting" className="hover:text-brand-accent transition-colors duration-200">
                  ייעוץ AI לארגונים
                </a>
              </li>
              <li>
                <a href="#training" className="hover:text-brand-accent transition-colors duration-200">
                  הדרכות צוות
                </a>
              </li>
              <li>
