          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-brand-text/80">
              ...
              <div className="flex space-x-4 space-x-reverse pt-4">
                ...
                <a href="https://www.instagram.com/ai.avi.frid/" target="_blank" rel="noopener noreferrer" className="text-brand-text/80 hover:text-brand-accent transition-colors duration-200">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
